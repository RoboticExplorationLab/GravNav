...
# function accel_perturbations2(epc::Epoch, x::Array{<:Real} ;
#              mass::Real=1.0, area_drag::Real=0.01, coef_drag::Real=1.3,
#              area_srp::Real=1.0, coef_srp::Real=1.4,
#              n_grav::Integer=3, m_grav::Integer=3)
#     """Accelerations for spacecraft in LEO, ForwardDiff friendly"""
#
#     # Extract position and velocity
#     r = x[1:3]
...
#
#     return [v1 / (dscale/tscale);
#             accel_perturbations2(t_current,[r1;v1]) / (dscale/tscale^2);
#             v2 / (dscale/tscale);
#             accel_perturbations2(t_current,[r2;v2]) / (dscale/tscale^2);
#             v3 / (dscale/tscale);
#             accel_perturbations2(t_current,[r3;v3]) / (dscale/tscale^2)]
# end
